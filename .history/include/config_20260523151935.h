...
// buttons
#define BTN1_PIN 7    // увеличить 
#define BTN2_PIN 10   // уменьшить 
#define BTN3_PIN 11   // настройка/подтвердить 
#define BTN4_PIN 12   // переключение экранов
...
#define SENSORS_READ_INTERVAL 1* 10
